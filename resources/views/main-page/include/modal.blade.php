                ...
                <div class="modal-body">
                    <div class="d-flex flex-row w-100 ">
                        ...
                        <div class="mb-3 flex-fill">
                            ...
                            <input type="text" class="form-control" id="lastName_edit" placeholder="Doe" name="last_name" required>
                        </div>
                    </div>
                    <div class="mb-3 flex-fill">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="street_edit" placeholder="jl.pesantren" name="street">
                    </div>
                    <div class="mb-3 flex-fill">
                        <label for="zipCode" class="form-label">ZIP Code</label>
                        <input type="number" class="form-control" id="zipCode_edit" placeholder="20122" name="zip_code">
                    </div>
                    <div class="mb-3">
